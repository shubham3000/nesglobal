...
export default function header(props) {
    ...
    return (
        <>
            <Navbar key='md' expand='md' className={isWhite ? 'navbar-light' : 'navbar-dark'}>
                <Container>
                    <Navbar.Brand href="/"><img src={isWhite ? "/images/Home/logo.png" : "/images/Home/logowhite1.png"}
                    ...
                    >
                        ...
                        <Offcanvas.Body>
                            <Nav className="justify-content-center flex-grow-1 dropdown">
                                {
                                    menuItems.map(item => {
                            ...
                            {showNav ?
                                <div className="search-nav">
                                    <ul>
                                        <li>
                                            <a href='#'><i className="far fa-search"
